...
3. パッケージファイルのインストール  
   ...
   ```
     cd /c/work
     pacman -U mingw-w64-x86_64-pdcurses-win10-jp-3.9-11-any.pkg.tar.xz
   ```
   ...
   ```
     cd /c/work
     pacman -U mingw-w64-i686-pdcurses-win10-jp-3.9-11-any.pkg.tar.xz
   ```
   ...
   ```
     cd /c/work
     pacman -U mingw-w64-x86_64-pdcurses-win8-jp-3.9-11-any.pkg.tar.xz
   ```
   ...
   ```
     cd /c/work
     pacman -U mingw-w64-i686-pdcurses-win8-jp-3.9-11-any.pkg.tar.xz
   ```
